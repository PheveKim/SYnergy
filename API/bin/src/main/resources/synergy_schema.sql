...
INSERT INTO videos (id, title, content, fitpartname, youtubeurl, channelname, viewcnt) values ('1', '하루 15분! 전신 칼로리 불태우는 다이어트 운동 (제목)', '하루 15분! 전신 칼로리 불태우는 다이어트 운동 (본문)', '전신', 'https://www.youtube.com/embed/swRNeYw1JkY', 'ThankyouBUBU', 0);